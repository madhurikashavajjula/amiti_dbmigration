						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									...
									<a href="#" class="btn kt-subheader__btn-secondary">My Profile</a><i class="fa fa-angle-right" aria-hidden="true"></i>
...
?>								
	...
	<div  role="document">
		...
		<form action="edit_Profile.php" id="form_profile_edit" method="POST" enctype="multipart/form-data">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							<label for="project-name" class="form-control-label">Name:</label>
							<input type="text" class="form-control" value="<?php echo $name ?>" name="name" id="patient_name_add" required>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label for="project-name" class="form-control-label">Mobile:</label>
							<input type="tel" class="form-control" value="<?php echo $mobile ?>" id="mobile"  name="mobile" required>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Email:</label>
							<input type="email" class="form-control" value="<?php echo $email ?>" name="email" id="email" required>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<a href="client_resetpwd.php">Reset Password</a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Qualification:</label>
							<input type="text" class="form-control" value="<?php echo $qualification ?>" name="qualification" id="qualification" >
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Designation:</label>
							<input type="text" class="form-control" value="<?php echo $designation ?>" name="designation" id="designation" >
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Building:</label>
							<input type="text" class="form-control" value="<?php echo $building ?>" name="building" id="building" >
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Street:</label>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">City:</label>
							<input type="text" class="form-control" value="<?php echo $city ?>" name="city" id="city" >
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Pincode:</label>
							<input type="text" class="form-control" value="<?php echo $pin ?>" name="pin" id="pin" >
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">State:</label>
			...
			<div class="modal-footer">
				<button type="submit" style="position: relative;right: 470px;" id="profile_edit" class="btn btn-primary">Save</button>

...
/*$patientCount = $conn->query("SELECT count(*) FROM patient WHERE created_by = '$created_by'")->fetchColumn();
$medicineCount = $conn->query("SELECT count(*) FROM medicine WHERE category = '$category'")->fetchColumn();*/

						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									...
									<a href="#" class="btn kt-subheader__btn-secondary">Add Documents</a><i class="fa fa-angle-right" aria-hidden="true"></i>
...
$query = "select * from tbl_category ORDER BY id DESC";
 ...
 ?>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Document:</label>
			...
			<div class="modal-footer">
				<button type="submit" style="position: relative;right: 470px;" id="add_document" class="btn btn-primary">Add Document</button>
			</div>
		</form>

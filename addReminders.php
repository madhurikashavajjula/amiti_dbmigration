						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									...
									<a href="#" class="btn kt-subheader__btn-secondary">Add Reminders</a><i class="fa fa-angle-right" aria-hidden="true"></i>
	...
	<div  role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Add New Reminders</h5>
			</div>
		<form action="AddReminder_db.php" id="form_client" method="POST" enctype="multipart/form-data">
			<div class="modal-body">
				<div class="row">
					<input type="hidden" value="<?php $emp_id?>" name="emp_id" id="emp_id">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label for="location" class="form-control-label">Memo:</label>
			...
			<div class="modal-footer">
				<button type="submit" style="position: relative;right: 470px;" id="addReminder" class="btn btn-primary">Save</button>
			</div>
		</form>

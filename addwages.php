...
<!-- begin:: Content Head -->
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									...
									<a href="#" class="btn kt-subheader__btn-secondary">Add Wages</a><i class="fa fa-angle-right" aria-hidden="true"></i>
	...
	<div  role="document">
		...
		<form action="AddWagesdb.php" id="form_client" method="POST" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="form-group">
							...
							<input type="text" class="form-control"  name="wageType" id="wageType" >
						</div>
					</div>
			...
			<div class="modal-footer">
				<button type="submit" style="position: relative;right: 470px;" id="addWage" class="btn btn-primary">Save</button>
			</div>
		</form>

...
<!-- begin:: Content Head -->
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-subheader__main">
								<h3 class="kt-subheader__title">Medicine</h3>
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									...
									<a href="#" class="btn kt-subheader__btn-secondary">Bulk Upload</a><i class="fa fa-angle-right" aria-hidden="true"></i>
	...
	<div  role="document">
		...
		<form action="uploadMedicine.php" id="form_client" method="POST" enctype="multipart/form-data">
...
$query = "select * from tbl_category ORDER BY id DESC";
 ...
 ?>
			...
			<div class="modal-footer">
				<button type="submit"  style="position: relative;right: 470px;" name="submit" id="submit" class="btn btn-primary">Submit</button>
			</div>
		</form>

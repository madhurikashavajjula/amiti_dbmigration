						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									...
									<a href="#" class="btn kt-subheader__btn-secondary" data-toggle="modal" data-target="#small_modal">Benefits</a><i class="fa fa-angle-right" aria-hidden="true"></i>
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
												...
												&nbsp;
												<a href="addBenefits.php" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script>
	function modal_client_edit(id){
		...
		var emp_id=id;
		window.location.href = "edit_benefits.php?emp_id="+emp_id;
	}

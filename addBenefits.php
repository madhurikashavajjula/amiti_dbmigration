						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									...
									<a href="#" class="btn kt-subheader__btn-secondary">Add Benefits</a><i class="fa fa-angle-right" aria-hidden="true"></i>
	...
	<div  role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Add New Benefits</h5>
			</div>
		<form action="AddBenefitname_db.php" id="form_client" method="POST" enctype="multipart/form-data">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							<label for="project-name" class="form-control-label">Benefit Name:</label>
			...
			<div class="modal-footer">
				<button type="submit" style="position: relative;right: 470px;" id="addBenefit" class="btn btn-primary">Save</button>
			</div>
		</form>

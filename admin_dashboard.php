...
$medicineCount = $conn->query("SELECT count(*) FROM medicine")->fetchColumn();
$Client_Count = $conn->query("SELECT count(*) FROM admin WHERE type = 'admin' ")->fetchColumn();
$category_Count = $conn->query("SELECT count(*) FROM tbl_category ")->fetchColumn();
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									<a href="#" class="btn kt-subheader__btn-secondary">Dashboard</a><i class="fa fa-angle-right" aria-hidden="true"></i>
								...
								<div class="col-md-12">
									...
									<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-widget17">
											...
											<div class="kt-widget17__stats" style="margin-top: 10px;">
												<div class="kt-widget17__items">
													<div class="kt-widget17__item">
														<h1>&nbsp;&nbsp;<?php echo $patientCount; ?></h1>
														<span class="kt-widget17__icon pull-right">

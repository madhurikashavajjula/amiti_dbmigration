...
<!-- begin:: Content Head -->
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									...
									<a href="#" class="btn kt-subheader__btn-secondary">Add Invoice</a><i class="fa fa-angle-right" aria-hidden="true"></i>
	...
	<div  role="document">
		...
		<form action="AddClient_db.php" id="form_client" method="POST" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Invoice Date:</label>
...
$query = "select * from tbl_category ORDER BY id DESC";
 ...
 ?>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Rate:</label>
							<input type="number" class="form-control"  name="rate" id="rate" >
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Discount %:</label>
...
$query = "select * from tbl_category ORDER BY id DESC";
 ...
 ?>
						...
						<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Invoice Period:</label>
							<input type="number" class="form-control"  name="invoice_period" id="invoice_period">
						</div>
						</div>
						<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Due Date:</label>
							<input type="date" class="form-control"  name="due_date" id="due_date">
						</div>
						</div>
						<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Invoice Amount:</label>
							<input type="number" class="form-control"  name="invoice_amount" id="invoice_amount">
						</div>
						</div>
						<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Received Amount:</label>
...
$query = "select * from tbl_category ORDER BY id DESC";
 ...
 ?>
								...
								<div class="col-md-6">
						<div class="form-group">
							<label for="location" class="form-control-label">Check/ACH Date:</label>
							<input type="date" class="form-control"  name="check_date" id="check_date" >
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label for="location" class="form-control-label">Follow up Notes:</label>
							<textarea class="form-control"  name="follow_notes" id="follow_notes" ></textarea>
						</div>
					</div>
			...
			<div class="modal-footer">
				<button type="submit" style="position: relative;right: 470px;" id="addInvoice" class="btn btn-primary">Save</button>
			</div>
		</form>
